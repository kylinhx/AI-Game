...
class ENV(gym.Env):
    ...
    def __init__(self, 
        ...
        # 初始化能量条数字模板
        self.template_list = self.load_energy_template(r'The_King_of_Fighters_XV\template')
...
if __name__ == "__main__":
    ...
    # cv2.imshow('self_energy_number_img', self_energy_number_img)
    # cv2.imshow('enemy_energy_number_img', enemy_energy_number_img)
    # cv2.waitKey(0)
    # print(type(window_img))

    # print(environment.get_observation_space().sample())

    print(environment.handle_energy_(enemy_energy_img, enemy_energy_number_img))